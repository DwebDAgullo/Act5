...
$(document).ready(function() {
  var tabla = $('#asignaturas').DataTable({
          ...
          bootbox.dialog({
            ...
            '<div class="form-group">' +
              ...
              '<div class="input-group">' +
                ...
                '</span>' +
                '<input type="text" id="agregar_alumnos" class="form-control" placeholder="Cantidad de Alumnos" required>' +
              '</div>' +
            '</div>',
            buttons: {
              cancel: {
    ...
    columns: [
      ...
      {data: 'alumnos', title: 'Cantidad de Alumnos'},
      {
      ...
      '<div class="form-group">' +
        '<div class="input-group">' +
          '<span class="input-group-addon">' +
            '<i class="glyphicon glyphicon-user"></i>' +
          '</span>' +
          '<input type="text" id="editar_alumnos" class="form-control" value="' + alumnos + '" placeholder="Cantidad de alumnos">' +
        '</div>' +
      '</div>',
      buttons: {
        cancel: {
